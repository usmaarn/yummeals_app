...
<footer class="p-10 bg-dark text-white/60 flex flex-col gap-10 md:flex-row md:items-center justify-between">
	<div class="space-y-5">
		<a href="/">
			<img src="/logo-light.png" alt="yummeals logo">
		</a>
		<p>Delivering Happiness, One Meal at a Time</p>
	</div>

	<div class="flex items-center gap-5 socials">
		<a href="/">
